          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {featuredBusinesses.map((biz) => (
              ...
              >
                ...
                <div className="p-4">
                  <span className="inline-block text-xs font-bold text-[#4CAF50] bg-[#4CAF50]/10 px-2 py-0.5 rounded-full mb-2 uppercase tracking-wider">
                    {biz.categorySlug}
                  </span>
                  <h3 className="font-bold text-base text-[#3a2512] group-hover:text-[#d97706] transition-colors leading-tight mb-1">
                    {biz.name}
                  </h3>
                  <p className="text-gray-500 text-xs mb-3 line-clamp-2">{biz.description}</p>
