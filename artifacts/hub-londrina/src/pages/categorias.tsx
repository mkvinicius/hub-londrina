...
export default function Categorias() {
  ...
  return (
    <Layout>
      <section className="pt-10 pb-20 bg-white relative z-10 transition-colors">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h1 className="font-black text-4xl md:text-5xl text-[#3a2512] mb-4">
              ...
              {categories.map((category) => {
                ...
                return (
                  <button
                    ...
                    className="group bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 text-left flex flex-col"
                  ...
                  >
                    ...
                    <div className="relative">
                      <div className="absolute left-1/2 -translate-x-1/2 -top-7 z-10">
                        <div className={`w-14 h-14 rounded-full ${colorClasses} shadow-md flex items-center justify-center border-[3px] border-white`}>
