...
import { LayoutDashboard, Store, Tag, Users, Zap, ImageIcon, ClipboardList, LogOut, Menu, X, CreditCard, Info, MapPin, FileText, Star, ScrollText, MessageSquare, Award, Scale, Mail, HelpCircle, BookOpen, Search } from "lucide-react";
...
const links: Array<{
  ...
  { href: "/admin/patrocinadores", label: "Patrocinadores", icon: Award },
  ...
  { href: "/admin/buscas", label: "Analytics de Busca", icon: Search },
