...
const SECURITY_HEADERS: Record<string, string> = {
  ...
  "Content-Security-Policy": [
    ...
    "connect-src 'self' ws: wss: https://api.stripe.com https://maps.googleapis.com https://viacep.com.br https://brasilapi.com.br https://www.instagram.com https://graph.instagram.com",
